...
public:
  ...
  virtual std::vector<double> findAVertex(std::vector <double>line_x, std::vector <double>line_y, std::vector<double> pose);
  virtual std::vector<double> findBVertex(std::vector <double>line_x, std::vector <double>line_y, std::vector<double> pose);
  ...
  virtual double findOrientation(std::vector<double> v, int num);
  virtual std::vector<double> clean (std::vector<double> vector);
